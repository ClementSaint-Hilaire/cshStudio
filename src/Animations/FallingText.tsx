  ...
  useEffect(() => {
    ...
    const newHTML = words
      .map((word) => {
        ...
        return `<span
          class="inline-block mx-[2px] select-none ${isHighlighted ? "text-cyan-500 font-bold" : "text-white"}"
          style="font-size: ${fontSize}; text-shadow: 0 0 10px rgba(255,255,255,0.1);"
        >
          ${word}
        </span>`;
      })
