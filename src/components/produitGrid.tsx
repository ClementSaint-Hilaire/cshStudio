    ...
    return (
        <section className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-12 bg-monochrome-100">
            ...
            <div className="max-w-[1680px] mx-auto">
                <div className="self-stretch max-w-[1680px] inline-flex flex-col justify-start items-start gap-16">
                    {products.map((product) => (
                        <AnimatedContent>
                        <div key={product.id} className="self-stretch max-w-[1680px] inline-flex justify-start items-start gap-16">
                            <div className="w-[650px] h-[500px] p-2.5 bg-[#1d1d1f] rounded-[5px]"></div>
