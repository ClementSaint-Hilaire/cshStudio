                            ...
                            <div className="inline-flex justify-start items-start gap-4">
                                ...
                                >
                                    ...
                                    <div className="absolute left-0 mt-2 w-[200px] bg-monochrome-800 rounded-[9px] shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10">
                                        ...
                                        <a href="https://linkedin.com/in/username" target="_blank" className="block px-4 py-3 text-monochrome-100 hover:bg-monochrome-600 font-satoshi flex items-center gap-2">
                                        ...
                                        <a href="https://twitter.com/username" target="_blank" className="block px-4 py-3 text-monochrome-100 hover:bg-monochrome-600 rounded-b-[9px] font-satoshi flex items-center gap-2">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
