        ...
        <section className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-12 bg-monochrome-100 gap-8">
            ...
            <div className="flex flex-col w-full gap-4">
                <div className="flex flex-col md:flex-row w-full gap-4">
                    <a className="w-1/2 bg-monochrome-200 h-[500px] rounded-[5px] flex flex-col gap-4 p-8">
                        ...
                        <div className="w-full justify-start text-monochrome-500 text-body md:text-heading font-medium font-satoshi">Restez informé des dernières actus tech sur plus de 11 thématiques. Chaque article est rédigé par la communauté et respecte des règles de rédactions factuelle et sourcés.</div>
                    ...
                    <a className="w-1/2 bg-monochrome-200 h-[500px] rounded-[5px] flex flex-col gap-4 p-8">
                        ...
                        <div className="w-full justify-start text-monochrome-500 text-body md:text-heading font-medium font-satoshi">Profitez d’une large collection d’outils gratuit / open sources, dédiés aux designers et développeurs, regroupant plus de 10 catégories pensées pour faciliter chaque étape de la création. Conçu pour optimiser les workflows, il offre des ressources pratiques et accessibles  pour gagner en efficacité et en précision.</div>
                ...
                <div className="flex flex-col md:flex-row w-full gap-4">
                    <a className="w-1/2 bg-monochrome-200 h-[500px] rounded-[5px] flex flex-col gap-4 p-8">
                        ...
                        <div className="w-full justify-start text-monochrome-500 text-body md:text-heading font-medium font-satoshi">cshStudio prévoit une large collection de templates open source sur Figma et Notion. Retrouvez les sur notre page produit et sur Figma </div>
                    ...
                    <a className="w-1/2 bg-monochrome-200 h-[500px] rounded-[5px] flex flex-col gap-4 p-8">
                        ...
                        <div className="w-full justify-start text-monochrome-500 text-body md:text-heading font-medium font-satoshi">Bienvenue dans Tech.Talk, votre rendez-vous hebdomadaire pour tout savoir sur l'actualité technologique.</div>
